...
type flex<TLength = (string & {}) | 0> = TLength | "auto" | "content" | "max-content" | "min-content" | "none" | baseType;
type basis<TLength = (string & {}) | 0> =
    ...
    | "min-content"
    | baseType;
type alignSelf = baseType | SelfPosition | "auto" | "baseline" | "normal" | "stretch";
...
const FlexItem: React.FC<Props> = (props) => {
    return (
        <div style={{
            order: props?.order,
            flex: props?.flex,
